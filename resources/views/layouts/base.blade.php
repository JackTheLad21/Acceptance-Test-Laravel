...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{ url('/') }}">
				<img alt="Logo" style="object-fit: contain" src="{{ asset('dashboard/media/logos/logo-light.png') }}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="{{ url('/home') }}" class="brand-logo">
							<img alt="Logo" style="object-fit: contain" src="{{ asset('dashboard/media/logos/logo-light.png') }}" class="max-w-100px" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
											<img class="h-20px w-20px rounded-sm" src="{{ asset('dashboard/media/svg/flags/013-italy.svg') }}" alt="" />
										</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
										...
										<ul class="navi navi-hover py-4">
											...
											{{-- <li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('dashboard/media/svg/flags/226-united-states.svg') }}" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{ asset('dashboard/media/svg/flags/013-italy.svg') }}" alt="" />
													</span>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
                                ...
                                &nbsp;
								<span class="text-dark-75 text-hover-primary">Project Name</span>
							</div>
							<!--end::Copyright-->
						</div>
						<!--end::Container-->
